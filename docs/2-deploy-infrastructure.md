---
title: "2. Deploy Infrastructure"
layout: default
nav_order: 2
parent: Home
---

# Milestone 2: Deploy Infrastructure
...
| `namespace 'Microsoft.CognitiveServices' not registered` | Provider not registered | `az provider register --namespace Microsoft.CognitiveServices --wait` |
...
> **Next:** [Milestone 3: Configure SQL Server →](3-configure-sql.md)
