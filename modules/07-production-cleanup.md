---
title: "7. Production & Cleanup"
nav_order: 8
parent: Home
description: "Harden for production or tear down resources"
permalink: /modules/07-production-cleanup/
---

# Module 7 — Production & Cleanup
{: .fs-8 }
...
| Least privilege RBAC | OpenAI User (not Contributor); Reader (not Contributor) |
...
- [Azure OpenAI production checklist](https://learn.microsoft.com/azure/ai-services/openai/how-to/production-best-practices)
...
[← Deploy the AI App]({{ site.baseurl }}{% link modules/06-deploy-ai-app.md %}){: .btn .btn-outline .fs-5 .mb-4 .mb-md-0 .mr-2 }
[Back to Home]({{ site.baseurl }}/){: .btn .fs-5 .mb-4 .mb-md-0 }
