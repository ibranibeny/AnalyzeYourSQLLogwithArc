---
title: "4. Configure SQL Server"
nav_order: 5
parent: Home
description: "Install SQL Express, create the InsuranceDB, verify log flow"
permalink: /modules/04-configure-sql/
---

# Module 4 — Configure SQL Server
{: .fs-8 }
...
The script `scripts/create-insurance-db.sql` creates **InsuranceDB** with tables:
...
[← Deploy Infrastructure]({{ site.baseurl }}{% link modules/03-deploy-infrastructure.md %}){: .btn .btn-outline .fs-5 .mb-4 .mb-md-0 .mr-2 }
[Next: Simulate Errors →]({{ site.baseurl }}{% link modules/05-simulate-errors.md %}){: .btn .btn-primary .fs-5 .mb-4 .mb-md-0 }
