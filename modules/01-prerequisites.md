...
nav_order: 3
parent: Home
description: "Verify Azure access, CLI tools, quotas, and environment setup"
...
[Next: Architecture →]({{ site.baseurl }}{% link architecture.md %}){: .btn .btn-primary .fs-5 .mb-4 .mb-md-0 }
